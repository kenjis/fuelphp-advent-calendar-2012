...
packageの意味ってなんですかね?そのへん誰か教えて下さい。

//note[[編注\] packageの意味]{
FuelPHPのパッケージの用途はライブラリです。Coreクラスに含まれないライブラリが標準でパッケージとしていくつか提供されています。また、自作ライブラリをパッケージ化したり、サードバーティ製のライブラリをFuelPHPで簡単に扱えるようにパッケージ化して使います。
//}
