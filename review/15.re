...
= FuelPHPドキュメント翻訳へのお誘い @<href>{https://twitter.com/NEKOGET,@NEKOGET}


ありがたい事に、今年も@<href>{http://atnd.org/events/33753,FuelPHP Advent Calendar 2012}に参加です。
@<href>{https://twitter.com/uemera,@uemera}さんの記事「就職活動サイトの構築にFuelPHPを使ったので事例紹介」に続いての記事になります。@<br>{}


FuelPHPのドキュメントを、ドキュメントはやはり日本語で読みたいよねということで翻訳を始めました。@<href>{https://github.com/NEKOGET/FuelPHP_docs_jp/,GitHubのgitリポジトリ}を利用し、翻訳をすすめています。今日時点で、165人の方にforkされ、翻訳が進められています。
...
MIZUNOさんの「@<href>{http://ounziw.com/2011/12/01/github-localize/,github でドキュメント日本語化}」がとてもわかりやすく解説くださっています。
 ...
 * @<href>{https://github.com/NEKOGET/FuelPHP_docs_jp/commits/1.3/develop_japanese,1.3の翻訳の履歴}
 * @<href>{https://github.com/NEKOGET/FuelPHP_docs_jp/commits/1.4/develop_japanese,1.4の翻訳の履歴}
 * @<href>{https://github.com/NEKOGET/FuelPHP_docs_jp/commits/1.5/develop_japanese,1.5の翻訳の履歴}
 ...
 * @<href>{http://fuelphp.jp/,http://fuelphp.jp/}



//image[fuelphpjp-550x464][http://fuelphp.jp/]{
//}
...
FuelPHPのドキュメント翻訳に興味を持たれましたら、ぜひ参加をお願いします。質問等、微力ですができるかぎり応えたいと思います(^-^)/@<br>{}
...
Twitter: @<href>{https://twitter.com/NEKOGET,@NEKOGET}


Blog: @<href>{http://pneskin2.nekoget.com/press/,http://pneskin2.nekoget.com/press/}
//}
