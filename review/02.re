...
= FuelPHPで画像をプログラムから出力する方法。切り取る方法。応用する方法。 @<href>{https://twitter.com/madmamor,@madmamor}


@<href>{http://atnd.org/events/33753,FuelPHP Advent Calendar 2012} 2日目です。@<href>{https://twitter.com/madmamor,@madmamor} です。昨日は @<href>{https://twitter.com/kenji_s,@kenji_s} さんの「FuelPHPのこの1年」でした。@<br>{}
 ...
 * @<href>{http://press.nekoget.com/fuelphp_doc/classes/image.html,http://press.nekoget.com/fuelphp_doc/classes/image.html}
 * @<href>{http://docs.fuelphp.com/classes/image.html,http://docs.fuelphp.com/classes/image.html}
 ...
 * @<href>{http://deepliquid.com/content/Jcrop.html,http://deepliquid.com/content/Jcrop.html}
 * @<href>{https://github.com/tapmodo/Jcrop,https://github.com/tapmodo/Jcrop}



Jcropは、比率固定の切り取りや、サイズ固定の切り取りが可能です。切り取りのchangeイベントも、随時キャッチできます。Jcrop側で、比率と、ミニマムな幅を制御すれば、サーバサイドの処理も楽になりますね。@<br>{}
 ...
 * @<href>{http://blueimp.github.com/jQuery-File-Upload/,http://blueimp.github.com/jQuery-File-Upload/}
 * @<href>{https://github.com/blueimp/jQuery-File-Upload,https://github.com/blueimp/jQuery-File-Upload}



明日は @<href>{https://twitter.com/mkkn_info,@mkkn_info} さんの「FuelPHP を使ったモジュール開発入門」です。お楽しみに！
